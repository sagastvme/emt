<template>
  <form @submit.prevent="changePicture" class="w-full">
    ...
    <label class="mt-4 block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-3 rounded-lg cursor-pointer text-center w-full md:w-auto"
           for="picture">
      Anadir imagen
    </label>
    <input name="picture"  id="picture" ref="newPicture" accept="image/jpeg,image/png,image/gif,image/webp" class="hidden" required
           type="file">
    <input type="submit" value="Anadir plano" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-3 rounded-lg cursor-pointer mt-4 w-full md:w-auto">
  </form>
  <teleport to="body">
