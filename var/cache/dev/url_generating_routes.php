...
return [
    ...
    'read_post' => [['category', 'user', 'id'], ['_controller' => 'App\\Controller\\ForumControllerLogic::readPost'], [], [['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'user', true], ['variable', '/', '[^/]++', 'category', true], ['text', '/read']], [], [], []],
    'replyToPost' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::replyToPost'], [], [['text', '/replyToPost']], [], [], []],
    'profile' => [['username'], ['_controller' => 'App\\Controller\\ForumControllerLogic::profile'], [], [['variable', '/', '[^/]++', 'username', true], ['text', '/profile']], [], [], []],
    'showPostsByCategory' => [['category', 'id'], ['_controller' => 'App\\Controller\\ForumControllerLogic::showPostsByCategory'], [], [['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'category', true], ['text', '/show']], [], [], []],
    'getPostsPublishedByUser' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::getPostsPublishedByUser'], [], [['text', '/getPostsPublishedByUser']], [], [], []],
    'deletePost' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::deletePost'], [], [['text', '/deletePost']], [], [], []],
    'getSavedPosts' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::getSavedPosts'], [], [['text', '/getSavedPosts']], [], [], []],
    'deleteSavedPost' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::deleteSavedPost'], [], [['text', '/deleteSavedPost']], [], [], []],
    'addPostToFavourites' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::addPostToFavourites'], [], [['text', '/addPostToFavourites']], [], [], []],
    'removePostFromFavourites' => [[], ['_controller' => 'App\\Controller\\ForumControllerLogic::removePostFromFavourites'], [], [['text', '/removePostFromFavourites']], [], [], []],
